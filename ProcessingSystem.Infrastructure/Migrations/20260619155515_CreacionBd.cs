        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EsMesaPartes = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Expedientes_Oficinas_OficinaId",
                        column: x => x.OficinaId,
                        principalTable: "Oficinas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("f22687c4-279e-473d-829d-476775988e40"), 0, "1a43ce77-4cd2-46dc-a35a-152187fcadd9", "admin@ejemplo.gob.pe", true, false, null, "ADMIN@EJEMPLO.GOB.PE", "ADMIN@EJEMPLO.GOB.PE", "AQAAAAIAAYagAAAAEFRqnwikmf2bKOlDVUkXm8HM9XqiNg9iPhoFwe6ltOap39ZLOevt/jjwZn3O0W+KSw==", null, false, "060b36ef-2f8f-4669-ba50-934d09f9d4d8", false, "admin@ejemplo.gob.pe" });

            migrationBuilder.InsertData(
                table: "Oficinas",
                columns: new[] { "Id", "EsMesaPartes", "EstaEliminado", "FechaCreacion", "FechaModificacion", "Nombre", "OficinaPadreId", "UsuarioCreacion", "UsuarioModificacion" },
                values: new object[] { new Guid("39ad7ee1-7f89-4ca0-b46c-fce77fc94720"), true, false, new DateTime(2026, 6, 19, 10, 55, 13, 14, DateTimeKind.Local).AddTicks(7510), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Mesa de Partes", null, "f22687c4-279e-473d-829d-476775988e40", null });
